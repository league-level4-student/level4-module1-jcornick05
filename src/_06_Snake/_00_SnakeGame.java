...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Don't hit your self as a snake";
	...
	private void setFoodLocation() {
		...
		int location1 = rand.nextInt(15);
		int location2 = rand.nextInt(12);
		Location loc = new Location(location1, location2);
